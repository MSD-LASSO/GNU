%testerC:\Users\awian\Desktop\MSD\samePiTest
clearvars
close all
mainPath='C:\Users\awian\Desktop\MSD\samePiTest';
...
for i = 3:length(pi1_directory)
    ...
    file_save_time_1(i-2,4)=60*str2double(str{19})+str2double(str{20})+str2double(str{21})/1e6;
    ...
    file_save_time_2(i-2,4)=60*str2double(str{19})+str2double(str{20})+str2double(str{21})/1e6;
