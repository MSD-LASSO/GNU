...
class filterDemod_ref(gr.top_block):
    ...
    def __init__(self, cutoff_freq=60000, decimation=1, gain=2, num_samples=10000000, samp_rate=2000000, save_file='', source_file='', trans_width=2000):
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('C:\\Users\\devri\\Documents\\RIT\\Sixth Semester\\MSD I\\GIT\\GNU_non_git\\SECOND_2_28_GPS_filtered\\pi2_test10.wav', 1, samp_rate, 8)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,True)
        self.blocks_head_0_0 = blocks.head(gr.sizeof_float*1, num_samples)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\devri\\Documents\\RIT\\Sixth Semester\\MSD I\\GIT\\GNU_non_git\\2_28_GPS_SECOND_pi2\\Time2020-02-28_19_27_50_114795_END_2020-02-28_19_27_50_993244', True)
...
def argument_parser():
    ...
    parser.add_option(
        "", "--cutoff-freq", dest="cutoff_freq", type="intx", default=60000,
