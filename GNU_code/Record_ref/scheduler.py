...
def my_job(Doppler):
    ...
    # count+=1
    # os.system('date')
    print('python record_ref.py --channel-freq='+str(Doppler)+' --samp-rate=2000000 --center-freq=437 --num-samples=6000000 --file-loc="/home/pi/Documents/Time'+str(datetime.now())+'"')
    os.system('python record_ref.py --channel-freq='+str(Doppler)+' --samp-rate=2000000 --center-freq=437 --num-samples=6000000 --file-loc="/home/pi/Documents/Time"'+str(datetime.now()))
