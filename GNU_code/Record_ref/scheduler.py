...
def my_job(Doppler):
    ...
    # count+=1
    os.system('date')
    # os.system('python record_ref.py --channel-freq='+str(Doppler)+' --samp-rate=2e6 --center-freq=437 --num-samples=6e6 --file-loc="/home/pi/Documents/Time"+str(datetime.now()')
