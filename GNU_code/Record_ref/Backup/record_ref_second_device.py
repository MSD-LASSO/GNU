...
# Title: Record Ref Second Device
...
class record_ref_second_device(gr.top_block):
    ...
    def __init__(self, center_freq=97000000, channel_freq=97900000, file_loc="/dev/null", num_samples=10000000, samp_rate=2000000):
        ...
        # Blocks
        ##################################################
        self.osmosdr_source_0 = osmosdr.source( args="numchan=" + str(1) + " " + 'hackrf=1,bias=1' )
...
def main(top_block_cls=record_ref_second_device, options=None):
    if options is None:
